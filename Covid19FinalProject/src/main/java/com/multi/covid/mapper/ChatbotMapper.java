...
public interface ChatbotMapper {
	...
	List<CenterVO> getAddrCenter(String address_three); // 주소로 백신센터 조회
	List<CenterVO> getFacility(String facility_name); // 시설 이름으로 백신센터 조회
	List<CenterVO> getFacility_loc(HashMap<String, String> map); 
}
