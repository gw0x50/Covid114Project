...
public class AISpeakerController {
	...
	@ResponseBody
	@RequestMapping("/patient") //일일확진자 및 누적확진자 조회
	public String getPatient(String day, String location) {
		return service.getPatient(day, location);
	}
	
	@ResponseBody
	@RequestMapping("/vaccine-center") //스피커 접속지역의 가까운 선별진료소 조회
	public String getVaccineCenter(String r1, String r2, String r3) { // r1 - 시, r2 - 구, r3 - 동
		List<String> list = service.getVaccineCenter(r1, r2, r3);	
		return list.get(0);
	}
	
	@ResponseBody
	@RequestMapping("/weather") //스피커 접속지역의 날씨정보 조회
